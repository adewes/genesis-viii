========================================================================
    KONSOLENANWENDUNG: Genesis VIII-Projektübersicht
========================================================================

Diese Genesis VIII-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die Genesis VIII-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen Genesis VIII.pch sowie eine vorkompilierte 
